-- Official MIMIC-IV table definitions (PostgreSQL) for hosp + icu modules.
--
-- This file is intentionally limited to CREATE SCHEMA / CREATE TABLE blocks.
-- Ingest code parses these definitions and creates equivalent DuckDB tables.
